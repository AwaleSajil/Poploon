...
#define RNX_BUBB 3                      //how many no of Rxn time expirement to be performed
...
void new_game()
{
    ...
    for(i=0; i<NO_BU; i++)
    {
        ...
        sp[i]->fill = (rnd(1,100)%13  == 0) ? 5 : 1;     //5 is stripe pattern of some balloon in setfillstyle
...
int main()
{
    ...
    for(;;)
    {
        ...
        case -1:
            closegraph();
            return(0);    //when exit is clicked on welcome screen
        }
    }
    closegraph();
    return 0;
