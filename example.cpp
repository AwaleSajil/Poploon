...
outtextxy(30,430,"THIS GAME HAS BEEN  DEVELOPED BY AKSHAY");
outtextxy(230,450,"http://cprogrammingbyakshay.blogspot.com");
while( getch() != 'q');
finish=1;
break;
}
...
outtextxy(50,10,"!.......BY Akshay.....!");
outtextxy(70,150,"BALLOON SHOOTING");
float octave[7] = { 130.81, 146.83, 164.81,  174.61, 196, 220, 246.94};
settextstyle(1,0,3);
setcolor(WHITE);
outtextxy(50,450,"cprogrammingbyakshay.blogspot.in");
while( !kbhit() )
{
